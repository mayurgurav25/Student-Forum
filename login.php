...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if ($num == 1){
        ...
        $showError = "Your account is still pending for approval! or You have not registered yet";
    }
}
...
<body>
    ...
    <div class="login text-center">
        ...
        <form name='login' action="/WTE3/login.php" method="POST"  onsubmit="return validate();" >

            <ul>

                <li><input type="text" placeholder="Enter User Id" id="username" name="username" size="12" class="form-control lg mb-3 mt-4" /></li>
                <li><input type="password" placeholder="Enter Password" id="password" name="password" size="12" class="form-control lg" /></li>
                ...
                <li><a style="color: white;text-decoration: none;" href="register.php">Don't have account? Sign up here</a></li>
            </ul>
